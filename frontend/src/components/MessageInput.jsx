    ...
    <div className="p-4 w-full">
        ...
        <div className="mb-3 flex items-center gap-2">
          <div className="relative">
            ...
            <button onClick={removeImage}
              className="absolute -top-1.5 -right-1.5 w-5 h-5 cursor-pointer rounded-full bg-base-300 flex items-center justify-center"
              type="button"
      ...
      <form onSubmit={handleSendMessage} className="flex items-center gap-2">
        <div className="flex-1 flex gap-2">
          <input type="text" className="w-full input border focus:outline-0 rounded-lg input-sm sm:input-md" placeholder="Type a message..." value={text} onChange={(e) => setText(e.target.value)} />
